    ...
    <div class="container">
        <div class="flex flex-wrap">
            ...
            <div class="w-full px-4 mb-12 md:w-1/3">
                ...
                <ul class="text-slate-500">
                    ...
                    <li>
                        <a href="/#product" class="inline-block text-base hover:text-primary mb-3">Produk</a>
                    </li>
                    <li>
        ...
        <div class="w-full pt-10 border-t border-slate-500">
            <div class="flex items-center justify-center ml-3 mb-5">
                ...
                <!-- WhatsApp -->
                <a href="https://wa.me/6281360688767" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                ...
                <!-- Facebook -->
                <a href="https://www.facebook.com/komik.scolar/" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
